...
class Solution
{
    ...
    {
      return bridges(adj, v);
    }
    public ArrayList<ArrayList<Integer>>bridges(ArrayList<ArrayList<Integer>> adj, int v){
        int dt[] = new int[v];
        int low[] = new int[v];
    ...
    int time = 0;
    public void dfs(ArrayList<ArrayList<Integer>> adj, boolean[]vis, int []dt, int[]low, int curr, int p, ArrayList<ArrayList<Integer>> ans){
        vis[curr]= true;
